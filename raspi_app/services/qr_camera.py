...
class QrCameraScanner:
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            self._error = fKhong the import picamera2: {error}
            return False
        ...
        try:
            ...
            self._error = fKhong the khoi dong Pi Camera: {error}
            self.stop()
            return False
    ...
    def capture(self) -> QrScanFrame:
        ...
        try:
            ...
            if frame is None:
                self._error = Mat ket noi camera
                return QrScanFrame(error=self._error)
            ...
            self._error = fKhong the doc camera: {error}
            return QrScanFrame(error=self._error)
